    ...
    gs_pairs = [
        # Pair 1: Similar software products
        {
            "applicant_good": models.GoodService(
                term="Software for legal research", nice_class=42
            ).model_dump(),
            "opponent_good": models.GoodService(
                term="Computer software for legal case management", nice_class=42
            ).model_dump(),
        ...
        {
            "applicant_good": models.GoodService(
                term="Printed publications", nice_class=16
            ).model_dump(),
...
def test_full_workflow_identical_marks_identical_goods(test_client):
    ...
    gs_pairs = [
        {
            "applicant_good": models.GoodService(
                term="Identical legal software", nice_class=9
            ).model_dump(),
            "opponent_good": models.GoodService(
                term="Identical legal software", nice_class=9
            ).model_dump(),
