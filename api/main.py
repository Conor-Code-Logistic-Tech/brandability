...
async def mark_similarity(
    ...
    try:
        ...
        # Handle errors from model validation
...
async def batch_gs_similarity(
    ...
    try:
        ...
        # Update the batch_process_goods_services function in trademark_core/llm.py to accept the model parameter
...
async def case_prediction(
    ...
    try:
        ...
        # Handle any errors from the case prediction logic
        raise HTTPException(
            status_code=500,
